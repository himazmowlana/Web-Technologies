...
<div class="work" style="display: flex;">
    ...
    <div class="locate" style="margin: 0 300px">
        <h2>Our Address</h2>
        <p class="locate">15, Hebdon Road, London<br> Opposite to Lidl</p>
    </div>
    
    <div class="contact" style="margin: 0 -10px">
        <h2>Contact Details</h2>
        <p class="contact">Office: 01174953338<br> Personal: 07440481254<br> Fax: 01172301725<br> Email: ironparadiseinfo@gmail.com</p>
    </div>
</div>
...
<!-----Design----->
    ...
    <p><div class="design" style="text-align: center">&copy; <em>2023</em> Iron Paradise (Fitness Website) Project | Designed by <strong>Himaz Mowlana</strong></div></p>
